...
const NavbarBeauty = () => {
  ...
  return (
    <>
      ...
      <div className="Middlee-box">
        <Link to="/Brands">
          <p className="Clothes" text="&nbsp;Brands&nbsp;">
            &nbsp;Brands&nbsp;
          </p>
        </Link>
        <Link to="/Care">
          <p className="Shoes" text="&nbsp;Care&nbsp;">
            &nbsp;Care&nbsp;
          </p>
        </Link>
        <Link to="/Makeup">
          <p className="Sneakers" text="&nbsp;Makeup&nbsp;">
            &nbsp;Makeup&nbsp;
          </p>
        </Link>
        <Link to="/Hair">
          <p className="Bags" text="&nbsp;Hair&nbsp;">
            &nbsp;Hair&nbsp;
          </p>
        </Link>
        <Link to="/Scent">
          <p className="Watches" text="&nbsp;Body&nbsp;">
            &nbsp;Body&nbsp;
          </p>
        </Link>
      </div>
